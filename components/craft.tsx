...
const styles = {
  typography: {
    base: [
      ...
      "[&_h1]:text-4xl [&_h1]:font-medium [&_h1]:leading-normal",
      "[&_h2]:text-3xl [&_h2]:font-medium [&_h2]:leading-normal",
      "[&_h3]:text-2xl [&_h3]:font-medium [&_h3]:leading-normal",
      "[&_h4]:text-xl [&_h4]:font-medium [&_h4]:leading-normal",
      "[&_h5]:text-lg [&_h5]:font-medium [&_h5]:leading-normal",
      "[&_h6]:text-base [&_h6]:font-medium [&_h6]:leading-normal",
      // Text elements
  ...
  layout: {
    spacing: "[&>*+*]:mt-6",
    article: "max-w-prose",
    container: "max-w-5xl mx-auto my-2 p-4",
    section: "py-4",
  },
};
