...
export default function IndexlyCTA() {
  const logoUrl = blogConfig.logoUrl || `${siteConfig.site_domain}/favicon.ico`;
  ...
  return (
    <div className="rounded-md border border-olive-100 bg-gradient-to-b from-olive-50 to-olive-100 ring-1 ring-olive-200/70 p-6 not-prose">
      <div className="flex items-center gap-2 mb-4">
        <span
          className="inline-flex h-8 w-8 items-center justify-center rounded-full bg-gray-200 p-1 overflow-hidden"
      ...
      <p className="mt-3 text-sm/6 text-olive-600">{blogConfig.ctaSubtitle}</p>
